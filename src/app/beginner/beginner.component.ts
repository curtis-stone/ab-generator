...
@Component({
  selector: 'beginner',
  templateUrl: './beginner.template.html',
...
export class BeginnerComponent {
  ...
  transverseOne = [
    ...
    'Kneeling Opposite Holds: 15 sec. each side',
    '6 inches: 15 sec.',
    'Leg Lifts: 10 reps',
    'Scissor Kicks: 10 reps on each leg'
  ];
  obliquesOne = [
    'Russian Twists: 10 reps on each side',
    'Side Plank Hip Lifts: 5 on each side',
    'Rotating Side Plank: 5 each side',
  ...
  obliquesTwo = [
    'Cross-Body Mountain Climbers: 10 reps each side',
